...
public class SupportCardSerMa extends SupportCard {
	...
	//Constructor
	public SupportCardSerMa(String name, String cardType, String skill, String effectDesc) {
	...
	public boolean effect(Player player) {
		...
		//Set boolean successfulTarget to the returned value of keyFunction's checkDeck method, passing player and 'Magic Creature' as arguments
		boolean successfulTarget = KeyFunction.checkDeck(player, "Magic Creature");
		...
		if (successfulTarget == true) {
			...
			System.out.println("Enter the position of the Magic Creature Card you wish to add to your Hand");
