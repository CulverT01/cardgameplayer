...
public class SupportCardSerMe extends SupportCard {
	...
	//Constructor
	public SupportCardSerMe(String name, String cardType, String skill, String effectDesc) {
	...
	public boolean effect(Player player, KeyFunction keyFunction) {
		...
		if (successfulTarget == true) {
			...
			System.out.println("Enter the position of the Melee Creature Card you wish to add to your Hand");
