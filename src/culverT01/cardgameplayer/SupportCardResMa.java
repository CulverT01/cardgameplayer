...
public class SupportCardResMa extends SupportCard {
	...
	//Constructor
	public SupportCardResMa(String name, String cardType, String skill, String effectDesc) {
	...
	public boolean effect(Player player, KeyFunction keyFunction) {
		...
		if (successfulTarget == true) {
			...
			System.out.println("Enter the position of the Magic Creature you wish to play from your Wasteland");
